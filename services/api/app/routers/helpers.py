...
def serialize_style(
    ...
    return NailStyleRead(
        ...
        nail_type=getattr(style, "nail_type", "press_on") or "press_on",
        source_type=getattr(style, "source_type", "seed_xlsx") or "seed_xlsx",
...
def serialize_post(post: UserPost) -> UserPostRead:
    return UserPostRead(
        ...
        nail_type=getattr(post, "nail_type", "press_on") or "press_on",
        source_type=getattr(post, "source_type", "user_upload") or "user_upload",

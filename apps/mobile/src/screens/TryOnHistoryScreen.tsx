                  ...
                  <DrawerModuleCard>
                    ...
                    <View style={styles.body}>
                      ...
                      <Text style={[styles.meta, { color: colors.subtext }]}>
                        创建于 {item.created_at.replace("T", " ").slice(0, 16)}
                      </Text>
                      <Text
                        style={[styles.prompt, { color: colors.subtext }]}
                        numberOfLines={2}
                      >
                      ...
                      <View style={styles.actions}>
                        ...
                        <Pressable
                          style={[
                            ...
                            deletingDisabled && styles.disabledAction,
                          ]}
